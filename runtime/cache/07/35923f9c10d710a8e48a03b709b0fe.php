<?php
//000000000000s:12237:"<div class="people-comment">
    <div class="deta-descri p">
        <div class="person-ph-name">
            <div class="per-img-n p">
                <div class="img-aroun"><img src="/template/pc/rainbow/static/images/defaultface_user_small.png"/></div>
                <div class="menb-name">
                                            匿名用户
                                    </div>
            </div>
        ...
        <div class="person-com">
            ...
            <div class="lifr4 requiimg p">
                                    <a href="/public/upload/goods/2016/01-14/56970ffcb99f8.jpg" target="_blank"><img src="/public/upload/goods/2016/01-14/56970ffcb99f8.jpg"/></a>
                                    <a href="/public/upload/goods/2016/01-14/56970ffc7cfca.jpg" target="_blank"><img src="/public/upload/goods/2016/01-14/56970ffc7cfca.jpg"/></a>
                                    <a href="/public/upload/goods/2016/01-14/56970ffc37d61.jpg" target="_blank"><img src="/public/upload/goods/2016/01-14/56970ffc37d61.jpg"/></a>
                            </div>
            <!--评论时间-->
    ...
    <!--点赞，回复-->
        <div class="g_come">
            ...
            <a  onclick="zan(this);"  data-comment-id="151"><i class="detai-ico z-ten"></i><span id="span_zan_151" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        ...
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_151" placeholder="回复 ：" maxlength="120"></textarea>-->
...
<div class="people-comment">
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="85"><i class="detai-ico z-ten"></i><span id="span_zan_85" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_85" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
...
<div class="people-comment">
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="19"><i class="detai-ico z-ten"></i><span id="span_zan_19" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_19" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
