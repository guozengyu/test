<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./template/pc/rainbow/cart\ajax_address.html";i:1495107366;}*/ ?>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="1" class="address">
                          <tbody>
                              <tr>
                                ...
                                <td width="60"  class="address_id"><input type="radio" onclick="swidth_address(this);" name="address_id" value="<?php echo $v[address_id]; ?>" checked="checked" /></td>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="1" class="address">
                      <tbody>
                          <tr>
                                <td width="60"  class="default"><i></i></td>
                                <td width="60"  class="co-red default">寄送至</td>
	                            <td width="60"  class="address_id"><input type="radio" onclick="swidth_address(this);" name="address_id" value="<?php echo $v[address_id]; ?>" /></td>
                                <td width="160" class="consignee"><b>收货人:<?php echo $v[consignee]; ?></b></td>
                                <td width="460"  class="address2"><span>地址:<?php echo $regionList[$v[province]]; ?> <?php echo $regionList[$v[city]]; ?> <?php echo $regionList[$v[district]]; ?> <?php echo $regionList[$v[twon]]; ?> <?php echo $v[address]; ?></span></td>
                                <td width="200" class="mobile"><span>电话：<?php echo $v[mobile]; ?></span></td>
