<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./template/pc/rainbow/goods\goodsInfo.html";i:1495107366;s:40:"./template/pc/rainbow/public\header.html";i:1495107366;s:46:"./template/pc/rainbow/public\footer_index.html";i:1495107366;s:46:"./template/pc/rainbow/public\sidebar_cart.html";i:1495107366;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="tpshop-tm-hander p">
    ...
    <div class="nav-middan-z p">
        <div class="header w1224">
            ...
            <div class="ecsc-join">
                <?php $pid =2;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1589446800 and end_time > 1589446800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
                ...
                <div class="standard p">
                    <ul>
                        ...
                        <li class="lawir">
                            ...
                            <div class="sav_shop">剩余库存：<span id="store_count"><?php echo $goods['store_count']-1; ?></span></div>
                        </li>
                    </ul>
                </div>
                <div class="standard p">
...
//        })
        ...
        function get_goods_price()
        {
            ...
            // 优先显示抢购活动库存
            <?php if(!(empty($goods['flash_sale']) || (($goods['flash_sale'] instanceof \think\Collection || $goods['flash_sale'] instanceof \think\Paginator ) && $goods['flash_sale']->isEmpty()))): ?>
                store_count = <?php echo $goods['flash_sale']['goods_num'] - $goods['flash_sale']['buy_num']; ?>;
